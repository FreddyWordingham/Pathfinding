...
impl Plugin for LightingPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins((
            ExtractComponentPlugin::<PostProcessSettings>::default(), // Extract data from ECS world.
            UniformComponentPlugin::<PostProcessSettings>::default(), // Write the data to the GPU uniform buffer.
        ));

        // Get the render app from the main app
